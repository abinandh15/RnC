import { fakeWeather, rainSpeed, snowSpeed } from '../params'
...
export function setClouds(weather: CurrentWeather) {
  ...
  switch (weather.weather) {
    case Weather.storm:
      ...
      clouds.getComponent(AudioSource).loop = true;     
      clouds.getComponent(AudioSource).playing = true     
      clouds.getComponent(Transform).position = new Vector3(16, 8, 8)
      break
    case Weather.snow:
      clouds.addComponentOrReplace(new GLTFShape('models/dark-cloud.gltf'))
      clouds.getComponent(Transform).position = new Vector3(20, 10, 8)
      break
    case Weather.heavyRain:
    ...
    case Weather.rain:
      clouds.addComponentOrReplace(new GLTFShape('models/clouds.gltf'))
      clouds.getComponent(Transform).position = new Vector3(20, 10, 12)
      break
    case Weather.clouds:
      clouds.addComponentOrReplace(new GLTFShape('models/clouds.gltf'))
      clouds.getComponent(Transform).position = new Vector3(20, 10, 12)
